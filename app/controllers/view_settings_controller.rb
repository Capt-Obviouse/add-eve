class ViewSettingsController < ApplicationController
  ...
  private
    ...
    def view_setting_params
      params.require(:view_setting).permit(:corporation_information, :programs, :operations, :communications, :finances, :general_information, :new_members, :eve_account_information, :user_id)
    end
end
